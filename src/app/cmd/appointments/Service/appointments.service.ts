...
export class AppointmentsService {
  ...
  createAppointment(obj: any){
    ...
    return this.http.post<any[]>("https://appointment.learn.skillassure.com/appointment/appointment/addApp", obj)
  ...
  getPatientDetail(){
    ...
    return this.http.get("https://appointment.learn.skillassure.com/appointment/appointment/addApp")
  ...
  newAppointment(appointment:any):Observable<any>{

    return this.http.post<any>('https://appointment.learn.skillassure.com/appointment/appointment/addApp',appointment,{headers:this.headers});
