...
import { PatientDetail } from '../../Model/patientDetail.model';
...
export class AddAppointmentComponent implements OnInit {
  ...
  constructor(
    ...
    private _service: AppointmentsService,
 ...
 // this.           
  ...
  if(this.isAdd){
      this.appointmentservice.newAppointment(this.appointment.value)
      .subscribe(appointment=>this.addappointment=appointment);
  }
 // comment
  }
